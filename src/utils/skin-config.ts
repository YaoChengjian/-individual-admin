import type {
  PredefinedLayout,
  SkinConfig
} from 'y-element-ultra/es/utils/theme-util';
...
export const PREDEFINED_LAYOUTS: PredefinedLayout[] = [
  ...
  },
  {
    ...
    config: {
      ...
      headerCustomStyle: null,
      tabsCustomStyle: {
        '--el-bg-color': 'var(--y-layout-bg)'
      },
      contentCustomStyle: null,
      layoutCustomStyle: {
        '--y-header-height': '46px',
        '--y-header-primary-bg': 'var(--el-color-primary)'
      },
      layoutCustomClass: null
    },
  ...
  },
  {
    ...
    config: {
      ...
      sideCustomStyle: {
        ...
        background: 'var(--y-sidebar-bg)'
      },
      headerCustomStyle: null,
      tabsCustomStyle: null,
      contentCustomStyle: null,
      layoutCustomStyle: {
        '--y-sidebox-width': '96px',
        '--y-sidebar-collapse-width': '70px',
        '--y-header-height': '46px'
      },
...
export const PREDEFINED_SKINS: SkinConfig[] = [
  ...
  },
  {
    ...
    color: '#5f80c7',
    cover: 'CoverModernDefault',
    themeClass: 'y-theme-modern',
    darkConfig: {
      color: '#5f80c7',
      cover: 'CoverModernDefault',
      themeClass: 'y-theme-modern-dark'
    },
