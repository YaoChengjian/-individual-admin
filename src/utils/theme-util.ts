...
import { changeColor, changeSkin } from 'y-element-ultra/es/utils/theme-util';
...
export function changeTheme(
  ...
  $html.className.split(' ').forEach((className) => {
    if (className.startsWith('y-theme-')) {
