...
import { defineComponent, inject, Ref, watch, PropType, toRaw, onUnmounted } from 'vue-demi';
...
// 生成几何信息
export const getGeometries = (geometries: TMap.PolylineGeometry[]) =>
	geometries.map((item: any) => {
		// 普通折线
...
// 生成图层样式
export function getStyle(options: { [key: string]: TMap.PolylineStyle }) {
