...
import type { TemplateItem } from 'y-element-ultra/es/y-pro-form-builder/types';
        ...
        },
        {
          ...
          props: {
            ...
            itemStyle: {
              ...
              textAlign: 'center',
              borderStyle: 'dashed',
              '--y-check-card-border-color': 'var(--el-border-color)'
            }
          },
          itemProps: {
            labelWidth: 0
      ...
      items: [
        ...
        },
        {
          ...
          props: {
            ...
            hasHeader: false,
            style: {
              '--y-table-border-color': 'var(--el-text-color-secondary)',
              tableLayout: 'fixed',
              marginBottom: '28px'
            }
          },
