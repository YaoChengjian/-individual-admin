...
import type { ComponentItem } from 'y-element-ultra/es/y-pro-form-builder/types';
import { defaultComponentData as componentData } from 'y-element-ultra/es/y-pro-form-builder/util';
import {
  codeTips,
  vIfCodeTips
} from 'y-element-ultra/es/y-pro-form-builder/components/component-data';
    ...
    configForm: [
      {
        ...
        type: 'label',
        props: { class: 'y-pro-form-builder-props-group-label' }
      },
      {
        label: '组件类型',
        prop: 'type',
      ...
      },
      {
        ...
        props: {
          ...
          class: 'y-pro-form-builder-props-options-check-card'
        }
      },
      {
        label: '组件属性',
    ...
    configForm: [
      ...
      },
      {
        ...
        props: {
          ...
          class: 'y-pro-form-builder-props-options-check-card is-loose'
        }
      },
      {
        label: '值类型',
