<template>
  <div class="y-file-picker-main">
    <div class="y-file-picker-body">
      <div class="y-file-picker-toolbar">
        <ElUpload
          action=""
          :accept="accept"
          :showFileList="false"
        ...
        <div class="y-file-picker-search">
          <ElInput
            :clearable="true"
      ...
      <template v-if="fileData.length">
        <div class="y-file-picker-file-list" @scroll="handleFileListScroll">
          <YFileList
            :boxChoose="true"
            :icons="localIcons"
...
<script lang="ts" setup>
  ...
  } from 'y-element-ultra/es/y-file-list/types';
  import {
    localIcons,
    localSmallIcons
  } from 'y-element-ultra/es/y-file-list/icons';
  import {
    SearchOutlined,
    MenuOutlined,
    AppstoreOutlined,
  ...
  /** 文件列表右键菜单属性 */
  const contextMenuProps = reactive<YDropdownProps>({
