...
<script lang="ts" setup>
  ...
  import { queryChild } from 'y-element-ultra';
  ...
  const handleGroupContextmenu = (e: MouseEvent, item: UserFile) => {
    ...
    )?.querySelector?.('.y-file-picker-tree-more');
    // @ts-ignore
