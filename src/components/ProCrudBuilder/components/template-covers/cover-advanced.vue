<template>
  <div
    class="y-icon-border-color-base"
    :style="{
      borderStyle: 'solid',
      borderWidth: '1px',
      borderRadius: '4px',
  ...
  >
    <div
      class="y-icon-border-color-base y-icon-bg-fill-extra-light"
      :style="{
        height: '40px',
        display: 'flex',
        alignItems: 'center',
...
<script lang="ts" setup>
  import { IconSkeleton } from 'y-element-ultra/es/y-pro-form-builder/components/icons/index';
</script>
