...
<template>
  <div class="y-code-viewer">
    <div class="y-code-viewer-line-numbers">
...
<style lang="scss">
  ...
  .y-code-viewer {
    ...
    overflow: auto;
    #{yVarName('scrollbar', 'color')}: #5e5e5e;
    #{yVarName('scrollbar', 'hover-color')}: #707070;
