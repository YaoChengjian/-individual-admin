<template>
  ...
  <el-icon
    ...
    class="y-layout-fullscreen-icon"
...
<script lang="ts" setup>
  ...
  import { LayoutTool, TabDropdown, checkFullscreen } from 'y-element-ultra';
  import type {
    MenuI18n,
    TabItemEventOption,
  ...
  const tabDropdownMenuStyle = {
    '--y-dropdown-item-padding': '0 18px',
    '--y-dropdown-item-height': '30px',
    '--y-dropdown-item-margin': '0px',
    '--y-dropdown-divider-margin': '3px 0',
    '--y-dropdown-icon-margin': '0 12px 0 -4px',
    '--y-dropdown-icon-size': '15px'
  };
