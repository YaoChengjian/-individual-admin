<!-- 皮肤背景 -->
<template>
  <div class="y-setting-layout-list y-setting-skin-list">
    <SettingLayoutItem
  ...
  <template v-if="showUserSkin">
    <SettingItem :title="t('layout.setting.skinConfig.wallpaper')">
      ...
      >
        <ElIcon
          class="y-setting-skin-item-cover y-setting-bg-upload"
...
<script lang="ts" setup>
  ...
  import { isColorValue } from 'y-element-ultra/es/utils/theme-util';
  import type { SkinConfig } from 'y-element-ultra/es/utils/theme-util';
