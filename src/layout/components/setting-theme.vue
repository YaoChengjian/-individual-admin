<template>
  <!-- 侧栏风格 -->
  <div class="y-setting-theme">
    <div class="y-setting-theme-item">
      <div
        class="y-setting-theme-item-cover y-setting-side-light"
    ...
    <div class="y-setting-theme-item">
      <div
        class="y-setting-theme-item-cover y-setting-side-dark"
  ...
  <div class="y-setting-theme">
    <div class="y-setting-theme-item">
      <div
        class="y-setting-theme-item-cover y-setting-head-light"
    ...
    <div class="y-setting-theme-item">
      <div
        class="y-setting-theme-item-cover y-setting-head-dark"
    ...
    <div class="y-setting-theme-item">
      <div
        class="y-setting-theme-item-cover y-setting-head-primary"
  ...
  <ElDivider />
  <!-- 导航布局 -->
  <YText type="placeholder" class="y-setting-title">
    {{ t('layout.setting.layout') }}
  </YText>
  <div class="y-setting-theme hidden-xs-only">
    <div class="y-setting-theme-item">
      <div
        class="y-setting-theme-item-cover y-setting-side-dark y-setting-layout-side"
    ...
    <div class="y-setting-theme-item">
      <div
        class="y-setting-theme-item-cover y-setting-head-dark y-setting-layout-top"
        @click="updateValue('layout', 'top')"
      >
        <YText v-if="layout === 'top'" type="primary" :icon="CheckOutlined" />
      </div>
      <div>{{ t('layout.setting.layoutStyles.top') }}</div>
    </div>
    <div class="y-setting-theme-item">
      <div
        class="y-setting-theme-item-cover y-setting-layout-mix"
        @click="updateValue('layout', 'mix')"
      >
        <YText v-if="layout === 'mix'" type="primary" :icon="CheckOutlined" />
      </div>
  ...
  <ElDivider />
  <!-- 重置 -->
  <div class="y-setting-footer">
    <ElButton size="small" class="y-fluid" @click="resetSetting">
