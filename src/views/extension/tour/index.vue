<template>
  <y-page>
    <y-card header="基本用法">
      ...
      <y-tour v-model="current1" :steps="steps1" />
    </y-card>
    <y-card header="不带遮罩层">
      <div>
      ...
      <y-tour v-model="current2" :steps="steps2" :mask="false" />
    </y-card>
    <y-card header="混合弹窗等多种形式">
      <div>
      ...
      <y-tour v-model="current3" :steps="steps3">
