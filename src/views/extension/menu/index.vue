    ...
    <y-card header="垂直菜单">
      ...
      <div style="display: flex; flex-wrap: wrap">
        <div style="margin: 0 12px 12px 0">
          <el-button type="primary" class="y-btn-icon" @click="changeData()">
            一级菜单分组形式
          </el-button>
        </div>
        <div style="margin: 0 12px 12px 0">
          <el-button type="primary" class="y-btn-icon" @click="changeColor()">
            更改菜单图标颜色
          </el-button>
        </div>
      </div>
...
<style lang="scss">
  .demo-menu-popper.y-menu > .el-menu--popup-container > .el-menu--popup {
    overflow: visible;
