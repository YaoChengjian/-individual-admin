...
<script lang="ts" setup>
  ...
  import type { YTableSelect } from 'y-element-ultra';
  import type { TableSelectProps } from 'y-element-ultra/es/y-table-select/props';
  ...
  /** 选择框实例 */
  const selectRef = ref<InstanceType<typeof YTableSelect> | null>(null);
