<template>
  <y-page>
    <y-card header="基础用法" :body-style="{ padding: 0 }">
...
<script lang="ts" setup>
  ...
  import type { ItemTooltip } from 'y-element-ultra/es/y-icon-select/types';
  ...
  /** 下拉模式 */
  const type = ref<PopperType>('popper');

  /** 图标网格 */
  const tooltipType = ref<ItemTooltip>(true);
</script>
