<template>
  <y-card header="轨迹展示及轨迹回放">
    ...
    <div>
      <el-button type="primary" class="y-btn-icon" @click="startTrackAnim">
        开始移动
      </el-button>
      <el-button type="primary" class="y-btn-icon" @click="pauseTrackAnim">
        暂停移动
      </el-button>
      <el-button type="primary" class="y-btn-icon" @click="resumeTrackAnim">
        继续移动
      </el-button>
    </div>
  </y-card>
