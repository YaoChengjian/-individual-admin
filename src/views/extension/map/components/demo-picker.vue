    ...
    <div>
      ...
      >
        <template #default="{ selected }">
          <el-button class="y-btn-icon" style="width: 134px">
      ...
      <el-button type="primary" class="y-btn-icon" @click="openMapPicker">
        打开位置选择
      </el-button>
    </div>
...
<script lang="ts" setup>
  ...
  import type {
    PoiItem,
    SelectMode
  } from 'y-element-ultra/es/y-map-picker/types';
