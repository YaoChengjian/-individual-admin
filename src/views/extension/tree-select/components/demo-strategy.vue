...
<script lang="ts" setup>
  ...
  import type { YTreeSelect } from 'y-element-ultra';
  import type { ShowCheckedStrategy } from 'y-element-ultra/es/y-tree-select/types';
  ...
  /** 树选择组件 */
  const treeSelectRef = ref<InstanceType<typeof YTreeSelect> | null>(null);
