<template>
  <y-card header="多列菜单" :body-style="{ padding: '12px' }">
    <frame-card>
      <y-admin-layout
        :height="600"
        ...
        :mobile="mobile"
        :style="{ '--y-sidebar-collapse-width': '74px' }"
      ...
      >
        ...
        <div :style="{ flex: 'auto', padding: '12px 12px 0 12px' }">
          ...
          <el-row :gutter="12">
            <el-col :span="12">
              <y-card style="height: 120px; margin-bottom: 12px" />
            </el-col>
            <el-col :span="12">
              <y-card style="height: 120px; margin-bottom: 12px" />
            </el-col>
            <el-col :span="16">
              <y-card style="height: 332px; margin-bottom: 12px" />
            </el-col>
            <el-col :span="8">
              <div>
                <y-card style="height: 160px; margin-bottom: 12px" />
                <y-card style="height: 160px; margin-bottom: 12px" />
              </div>
            </el-col>
            <el-col :span="8">
...
<style lang="scss" scoped>
  .demo-menu-wrapper :deep(.y-admin-sidebar) {
    background: #121319;
    --el-color-primary: #328dfc;

    .el-menu {
      padding: 0 8px;
      --y-menu-dark-color: #fff;
