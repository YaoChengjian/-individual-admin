<template>
  <y-card header="基础用法" :body-style="{ padding: '12px' }">
    <frame-card :style="mobile ? { maxWidth: '420px' } : {}">
      ...
      >
        <y-admin-layout
          ...
          :style="{
            '--y-header-height': headerHeight + 'px',
            '--y-sidebar-width': sidebarWidth + 'px',
            '--y-sidebox-width': sideboxWidth + 'px',
            '--y-sidebar-mix-width': sidebarMixWidth + 'px'
          }"
        >
          <template #logo>
...
<script lang="ts" setup>
  ...
  import { LayoutTool } from 'y-element-ultra';
  import { useTimer } from 'y-element-ultra/es/utils/hook';
  import {
    SettingOutlined,
    UserOutlined,
    IdcardOutlined,
  ...
  import type {
    ...
    TabStyle,
    Maximized
  } from 'y-element-ultra/es/y-admin-layout/types';
  import type { MenuItem } from 'y-element-ultra/es/y-menus/types';
  import type { TabPaneItem } from 'y-element-ultra/es/y-tabs/types';
  import type { BreadcrumbItem } from 'y-element-ultra/es/y-breadcrumb/types';
