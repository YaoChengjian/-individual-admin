<template>
  <y-card header="消息通知">
    <option-item label="使用">
      <el-button @click="showNotification()" class="y-btn-icon">
        打开通知
      </el-button>
      <el-button @click="showNotification('success')" class="y-btn-icon">
        带图标
      </el-button>
      <el-button @click="showNotification('info', 0)" class="y-btn-icon">
        不自动关闭
      </el-button>
    </option-item>
