<template>
  <y-card header="消息提示">
    ...
    <option-item label="合并相同内容">
      <el-button @click="showGroup('success', '内容一')" class="y-btn-icon">
        内容一
      </el-button>
      <el-button @click="showGroup('success', '内容二')" class="y-btn-icon">
        内容二
      </el-button>
    ...
    <option-item label="限制在指定区域">
      <el-button @click="showInDemoWrap" class="y-btn-icon">提示</el-button>
      <el-button @click="openModal" class="y-btn-icon">
        限制在指定弹窗
      </el-button>
    </option-item>
    <div
    ...
    >
      ...
      <div ref="demoMessageWrapRef" class="y-message-wrapper"></div>
    </div>
...
<script lang="ts" setup>
  import { ref } from 'vue';
  import { useMessage, useMessageBox, random } from 'y-element-ultra';
