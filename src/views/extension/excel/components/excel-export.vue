<template>
  <y-card header="导出 Excel" :body-style="{ padding: '18px 20px' }">
    <y-pro-table
      row-key="key"
      :columns="columns"
      :datasource="data"
    ...
    >
      <template #toolbar>
        <el-space :size="12" wrap>
          <el-button type="primary" class="y-btn-icon" @click="exportBas">
            导出
          </el-button>
          <el-button type="primary" class="y-btn-icon" @click="exportAdv">
            导出带表头合并
          </el-button>
          <el-button type="primary" class="y-btn-icon" @click="exportSel">
            导出选中
          </el-button>
        </el-space>
      </template>
