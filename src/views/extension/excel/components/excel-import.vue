<template>
  <y-card header="导入 Excel">
    <el-space>
      ...
      >
        <el-button type="primary" class="y-btn-icon">导入</el-button>
      </el-upload>
      <el-upload
        action=""
        accept=".xls,.xlsx"
      ...
      >
        <el-button type="primary" class="y-btn-icon">
          导入拆分合并
        </el-button>
      </el-upload>
      <el-upload
...
<script lang="ts" setup>
  ...
  const importFile = (file: File) => {
    ...
    const loading = YMessage.loading({ message: '加载中..', plain: true });
