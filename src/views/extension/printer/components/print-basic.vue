  ...
  <y-card header="基础用法">
    <el-form label-width="80px" style="max-width: 320px" @submit.prevent="">
      ...
      <el-form-item label="打印位置">
        <el-select class="y-fluid" v-model="option.target">
    ...
    >
      <div style="overflow: auto">
        <y-table has-footer style="min-width: 600px" size="large">
          <colgroup>
            <col width="38px" />
            <col width="200px" />
            <col width="140px" />
...
<script lang="ts" setup>
  ...
  import type {
    ...
    PrintOrientation,
    PrintTarget
  } from 'y-element-ultra/es/y-printer/types';
  import type { Project } from '@/api/example/model';
