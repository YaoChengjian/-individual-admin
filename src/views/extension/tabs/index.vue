<template>
  <y-page>
    <y-card header="基础用法">
      ...
      <option-item label="风格" style="margin: 0">
        <div style="max-width: 220px">
          <el-select v-model="type" class="y-fluid">
    ...
    <y-card header="自定义风格" :body-style="{ paddingTop: '6px' }">
...
<script lang="ts" setup>
  ...
  import type { TabSize, TabType } from 'y-element-ultra/es/y-tabs/types';
...
<style lang="scss" scoped>
  ...
  /* 自定义样式 */
  div.demo-tabs.y-tabs :deep(.el-tabs__header) {
    --y-tab-padding: 0;
    --y-tab-height: 46px;
    --y-tab-font-size: 16px;
    --y-tab-simple-hover-color: var(--el-color-primary);
    --y-tab-simple-hover-bg: none;
    --y-tab-simple-active-bg: none;
    --y-tab-simple-active-weight: normal;
