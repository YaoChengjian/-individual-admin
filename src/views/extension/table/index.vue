<template>
  <y-page :multi-card="false">
    <y-card :body-style="{ padding: 0, overflow: 'hidden' }">
      <y-split-panel
        space="0px"
        size="180px"
        ...
        style="min-height: 708px; border-radius: var(--y-card-radius)"
      >
        <y-menus :items="items" :default-active="active" class="demo-menu" />
        <template #body>
