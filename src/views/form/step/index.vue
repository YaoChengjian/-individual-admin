<template>
  <div>
    <y-card style="border-radius: 0">
      <y-text type="heading" size="lg">分步表单</y-text>
      <y-text type="placeholder" style="margin-top: 6px">
        将一个冗长或用户不熟悉的表单任务分成多个步骤，指导用户完成。
      </y-text>
    </y-card>
    <y-page>
      <y-card class="step-card">
        ...
        <template v-if="active === 0">
          ...
          <y-alert :closable="false">
            <y-text size="lg" style="margin-bottom: 12px">说明</y-text>
            <y-text size="md" style="margin-bottom: 8px">
              转账到支付宝
            </y-text>
            <y-text style="margin-bottom: 12px">
              如果需要，这里可以放一些关于产品的常见问题说明。如果需要，
              这里可以放一些关于产品的常见问题说明。如果需要，这里可以放一些关于产品的常见问题说明。
            </y-text>
            <y-text size="md" style="margin-bottom: 8px">转账到微信</y-text>
            <y-text style="margin-bottom: 8px">
              如果需要，这里可以放一些关于产品的常见问题说明。如果需要，
              这里可以放一些关于产品的常见问题说明。如果需要，这里可以放一些关于产品的常见问题说明。
            </y-text>
          </y-alert>
