<template>
  <y-page>
    <top-search />
    <y-card :body-style="{ padding: '16px 8px' }">
          ...
          <div class="list-item-body">
            <div style="flex: 1">
              ...
              <div style="margin-top: 16px; display: flex; align-items: center">
                ...
                <y-text type="secondary" style="flex: 1; padding-left: 6px">
                  {{ item.user }} 发表于 {{ item.time }}
                </y-text>
              </div>
              <div style="margin-top: 16px; display: flex; align-items: center">
                <y-text :icon="Star" type="placeholder" style="cursor: pointer">
                  &nbsp;{{ item.likes }}
                </y-text>
...
<script lang="ts" setup>
  ...
  import { random } from 'y-element-ultra';
