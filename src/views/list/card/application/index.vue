  ...
  <y-page :multi-card="false">
        ...
        >
          <div style="padding: 24px">
            <div style="display: flex; align-items: center">
              ...
              <y-text size="md" style="flex: 1; padding-left: 12px">
                {{ item.title }}
              </y-text>
            </div>
            <y-ellipsis style="margin-top: 16px">
              网址: {{ item.url }}
            </y-ellipsis>
            <y-ellipsis style="margin-top: 6px">
              最后更新时间: {{ item.time }}
            </y-ellipsis>
          </div>
          <el-divider style="margin: 0; opacity: 0.48" />
          <div class="list-item-footer">
            <y-tooltip placement="top" content="分享" :offset="-8">
              <y-text
                :icon="Share"
                type="secondary"
            ...
            <y-tooltip placement="top" content="设置" :offset="-8">
              <y-text
                :icon="Tools"
                type="secondary"
                class="list-item-tool"
            ...
            <el-divider direction="vertical" style="margin: 0; opacity: 0.8" />
            <y-tooltip placement="top" content="删除" :offset="-8">
              <y-text
                :icon="DeleteFilled"
                type="secondary"
                class="list-item-tool"
    ...
    <y-pagination
      ...
      :style="{
        ...
        '--y-pagination-hover-bg': 'transparent',
        '--y-pagination-hover-color': 'var(--el-color-primary)'
      }"
    />
  </y-page>
</template>
