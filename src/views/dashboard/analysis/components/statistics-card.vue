...
<template>
  <el-row :gutter="16">
    <el-col :md="6" :sm="12" :xs="24">
      <y-card class="statistics-card">
        <y-text type="placeholder" class="statistics-header">
          <div class="statistics-header-text">总销售额</div>
          <y-tooltip content="指标说明" placement="top" :offset="6">
            <el-icon class="statistics-header-tip">
              <QuestionCircleOutlined />
            </el-icon>
          </y-tooltip>
        </y-text>
        <y-text size="xxl" class="statistics-value">¥ 126,560</y-text>
        <div class="statistics-body">
          <div class="statistics-trend-text">
            <div>周同比12%</div>
            <y-text type="danger" :icon="CaretUpFilled" />
          </div>
          <div class="statistics-trend-text">
            <div>日同比11%</div>
            <y-text type="success" :icon="CaretDownFilled" />
          </div>
        </div>
        <el-divider />
        <div>日销售额 ￥12,423</div>
    ...
    <el-col :md="6" :sm="12" :xs="24">
      <y-card class="statistics-card">
        ...
        <y-text size="xxl" class="statistics-value">8,846</y-text>
        <v-chart
          ref="visitChartRef"
    ...
    <el-col :md="6" :sm="12" :xs="24">
      <y-card class="statistics-card">
        ...
        <y-text size="xxl" class="statistics-value">6,560</y-text>
        <v-chart
          ref="payNumChartRef"
    ...
    <el-col :md="6" :sm="12" :xs="24">
      <y-card class="statistics-card">
        ...
        <y-text size="xxl" class="statistics-value">78%</y-text>
        <div class="statistics-body">
          <el-progress
