        ...
        >
          <template #item="{ element }">
            <tr>
              ...
              <td>
                <y-ellipsis style="line-height: 20px">
              ...
              <td style="text-align: center; width: 80px">
                <y-text v-if="element.status === 0" type="warning">
                  未开始
                </y-text>
                <y-text v-else-if="element.status === 1" type="success">
                  进行中
                </y-text>
                <y-text v-else-if="element.status === 2" type="info" deleted>
                  已完成
                </y-text>
              </td>
            </tr>
