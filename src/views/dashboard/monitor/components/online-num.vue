<template>
  <y-card header="在线人数">
    <div style="text-align: center">
      <y-text type="placeholder">{{ currentTime }}</y-text>
      <y-text size="xxxl">
        <y-count-up :end-val="onlineNum" />
      </y-text>
      <y-text type="placeholder" style="margin-bottom: 11px">
        在线总人数
      </y-text>
      <y-dot :text="updateTimeText" size="8px" />
    </div>
  </y-card>
</template>
